...
namespace MastermindGameService.AppLogic
{
    public class GameLogic
    {
        public Game getGameByID(int id, MastermindGameDBContext db)
        {
        ...
        public List<Game> getGameList(MastermindGameDBContext db)
        {
        ...
        public string addGame(Game game, MastermindGameDBContext db)
        {
            if (game != null)
            {
        ...
        public string updateGame(Game game, MastermindGameDBContext db)
        {
            if (game != null)
            {
                var existingGame = db.Game.Find(game.Id);
        ...
        /* public List<Leaderboard> getLeaderboards(MastermindGameDBContext db)
         {
